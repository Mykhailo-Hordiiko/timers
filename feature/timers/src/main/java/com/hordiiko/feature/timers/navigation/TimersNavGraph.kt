...
fun NavGraphBuilder.timersNavGraph() {
    ...
    composable(Screen.StopwatchCreate.route) { StopwatchCreateScreen() }
    composable(Screen.CountdownCreate.route) { CountdownCreateScreen() }
    composable(Screen.PomodoroCreate.route) { PomodoroCreateScreen() }
    composable(Screen.TabataCreate.route) { TabataCreateScreen() }
}